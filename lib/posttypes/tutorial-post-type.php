<?php
function at_tutorial_post_type() {

	$singular = __( 'Tutorial', 'awesome-tutorials' );
	$plural = __( 'Tutorials', 'awesome-tutorials' );
	...
	register_post_type( 'at_tutorial', $args );

}
add_action( 'init', 'at_tutorial_post_type', 0 );
?>
